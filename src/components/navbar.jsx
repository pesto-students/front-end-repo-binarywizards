    ...
    <nav className="bg-white dark:bg-gray-900 fixed w-full z-20 top-0 start-0 border-b border-gray-200 dark:border-gray-600">
      <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
        ...
        <div className="flex lg:order-2 space-x-3 lg:space-x-0 rtl:space-x-reverse">
          ...
          <button
            type="button"
            className="text-white bg-accent hover:bg-accent-900 focus:ring-4  focus:outline-none  focus:ring-accent-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 hidden min-[420px]:block"
