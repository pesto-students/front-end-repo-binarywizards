...
import { createHTMLFromJSON, ignoreTags } from "src/utils/utils";
              ...
              children: [
                {
                  ...
                  attributes: {
                    class:
                      "w-[4px] h-[4px] mr-2 flex items-center justify-center text-[#B4C6FC]",
                  },
                  className:
                    "w-[4px] h-[4px] mr-2 flex items-center justify-center text-[#B4C6FC]",
                  children: [
                ...
                },
                {
                  ...
                  children: [
                    ...
                    },
                    {
                      ...
                      className: "text-[11px] leading-4 text-[#6B7280] mt-2",
                      children: [
                        {
                          type: "text",
                          content: "ML ENGINEER | Jan 2022 - Present",
                        },
                      ],
                    },
                    {
...
const Template = () => {
  let myTemplate = createHTMLFromJSON(json, ignoreTags);
  return (
    <div
  ...
  //               </svg>
  //             </div>
  //             <p className="text-[11px] leading-4 text-white">123-456-789</p>
  //           </div>
  //         </div>
  //         <div className="template-contact-section mx-4 mt-6">
  //           <h1 className="text-xs leading-none text-white uppercase font-bold mb-2">
  ...
  //           </h1>
  //           <div className="flex items-start">
  //             <div className="w-[4px] h-[4px] mr-2 flex items-center justify-center text-[#B4C6FC]">
